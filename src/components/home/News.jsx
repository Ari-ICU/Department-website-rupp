        ...
        <div className="flex justify-center items-center gap-2 sm:gap-4 mt-6 sm:mt-8">
          <button
            ...
            className={`p-2 rounded-full ${
              currentPage === 1 ? 'bg-gray-300 cursor-not-allowed' : 'bg-red-600 text-white hover:bg-red-700'
            }`}
          ...
          <button
            ...
            className={`p-2 rounded-full ${
              currentPage === totalPages ? 'bg-gray-300 cursor-not-allowed' : 'bg-red-600 text-white hover:bg-red-700'
            }`}
