            ...
            <div className='container mx-auto '>
                <section className="flex flex-col lg:flex-row gap-8">
                    ...
                    >
                        ...
                        <p className="xl:text-lg text-[12px] text-gray-500 mb-6">Our curriculum emphasizes both theoretical and practical aspects of computer science, equipping graduates with the skills needed for a successful career in the ever-evolving tech industry.</p>

                        {/* Program Info */}
                        <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6 text-base xl:text-'>
                            {["Undergraduate Program", "Graduate Program"].map((program, index) => (
                                ...
                                >
                                    ...
                                    <p className="2xl:text-lg xl:text-[14px] text-red-800 font-medium">{program}</p>
                                </motion.div>
                            ))}
                        </div>
