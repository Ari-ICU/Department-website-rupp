...
//image import 
import s1 from "../../assets/img/undergraduate/u1.png";
import s2 from "../../assets/img/undergraduate/u1.png";
import s3 from "../../assets/img/undergraduate/u1.png";

function UndergraduateProgramSlider() {
  ...
  return (
    <div className="relative bg-white shadow-md overflow-hidden">
      ...
      {/* Foreground Content */}
      <div className="relative z-10 container mx-auto flex justify-center items-center min-h-[400px] py-6">
        <div className="flex flex-col w-full text-center text-white xl:w-[782px] p-2 *:py-4 ">
          <h2 className="xl:text-3xl text-lg font-semibold drop-shadow-md">
            Undergraduate Program
          </h2>
          <p className="text-md xl:text-lg text-gray-200 drop-shadow-md mb-6">
...
export default UndergraduateProgramSlider;