        ...
        <div className="my-16 py-4 bg-white">
            ...
            >
                ...
                <motion.div 
                    ...
                    viewport={{ once: true }}
                    className="grid grid-cols-1 lg:grid-cols-2 justify-center gap-6"
                >
                    {studyPlan.map((year, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className={`rounded-xl p-6 shadow-md ${selectedYear === year.year ? 'bg-red-900 text-white' : 'bg-white'}`}
                        ...
                        >
                           <div className={`w-12 h-12 rounded-full flex items-center justify-center mb-4`}>
                            ...
                            <p className={`mb-4 text-start ${selectedYear === year.year ? 'text-gray-300' : 'text-gray-600'}`}>
                                {year.subtitle}
                            </p>
