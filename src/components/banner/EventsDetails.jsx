...
import scholar from "../../assets/banner/events.png";

const EventsDetailsBanner = () => {
    const title = "RUPP Hosts Exciting Career Fair, Connecting Students with Top Employers";
...
export default EventsDetailsBanner;