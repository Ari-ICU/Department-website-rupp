      ...
      <div className='container mx-auto px-4'>
        <div className='p-8'>
          <div className="max-w-2xl text-center relative">
            {/* Top Quote Icon */}
            <FaQuoteLeft className="text-red-800 text-4xl md:text-5xl absolute -top-6 left-4 transform -translate-x-1/2" />
            ...
            {/* Bottom Quote Icon */}
            <FaQuoteRight className="text-red-800 text-4xl md:text-5xl absolute -bottom-6 right-0 transform -translate-x-1/2" />
          </div>
        </div>
