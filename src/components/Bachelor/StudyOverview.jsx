...
const StudyOverview = () => {
    ...
    const studyPlan = [
        ...
        },
        {
            year: 4,
            title: 'Year 4',
            subtitle: 'Capstone & Industry Exposure',
            color: 'bg-purple-600',
            courses: [
                'Final year project or research thesis.',
                'Internship for hands-on industry experience.',
                'Elective courses (Blockchain, IoT, Robotics) and entrepreneurship in tech.',
                'Ethics, professional development, and startup strategies.'
            ]
        }
    ];
